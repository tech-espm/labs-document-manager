...
!function(a){a.fn.datepicker.dates["en"]={days:["Sunday","Monday","Tueasday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],daysMin:["S","M","T","W","T","F","S"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dez"],today:"Today",clear:"Clear"}}(jQuery);

window.prepareDatePicker = function (id) {
	// http://bootstrap-datepicker.readthedocs.org/en/latest/options.html#format
	var i$ = $(id), d = i$.datepicker({
		format: (window.currentLanguageId === 1 ? "M/dd/yyyy" : "dd/M/yyyy"),
		todayBtn: true,
		language: (window.currentLanguageId === 1 ? "en" : "pt-BR"),
		calendarWeeks: true,
		autoclose: true,
		todayHighlight: true
	});
...
window.setDatePickerValue = function (input, value) {
	var i;
	if ((i = $(input)[0])) {
		i.value = value;
