...
namespace DocumentManager.Localization {
	...
	public class Str {
		...
		public static string InvalidPartitionType => CurrentLanguage == LanguageEn ? "Invalid dimension!" : "Dimensão inválida!";
		...
		public static string PartitionTypes => CurrentLanguage == LanguageEn ? "Dimensions" : "Dimensões";
		public static string PartitionType => CurrentLanguage == LanguageEn ? "Dimension" : "Dimensão";
		public static string PARTITIONTYPE => CurrentLanguage == LanguageEn ? "DIMENSION" : "DIMENSÃO";
		...
		public static string thePartitionType => CurrentLanguage == LanguageEn ? "the dimension" : "a dimensão";
		public static string EditPartitionType => CurrentLanguage == LanguageEn ? "Edit Dimension" : "Editar Dimensão";
		public static string partitionType => CurrentLanguage == LanguageEn ? "dimension" : "dimensão";
		public static string PartitionTypeNotFound => CurrentLanguage == LanguageEn ? "Dimension not found!" : "Dimensão não encontrada!";
		...
		public static string CreatePartitionType => CurrentLanguage == LanguageEn ? "Create Dimension" : "Criar Dimensão";
		public static string DoYouReallyWantToDeleteThePartitionType => CurrentLanguage == LanguageEn ? "Do you really want to delete the dimension?" : "Tem certeza que deseja excluir a dimensão?";
		public static string PartitionTypesBasicInformation => CurrentLanguage == LanguageEn ? "Dimension's Basic Information" : "Informações Básicas da Dimensão";
		public static string PartitionTypeSuccessfullyCreated => CurrentLanguage == LanguageEn ? "Dimension successfully created! 😄" : "Dimensão criada com sucesso! 😄";
		public static string PartitionTypeSuccessfullyChanged => CurrentLanguage == LanguageEn ? "Dimension successfully changed! 😄" : "Dimensão alterada com sucesso! 😄";
		public static string ManagePartitionTypes => CurrentLanguage == LanguageEn ? "Manage Dimensions" : "Gerenciar Dimensões";
